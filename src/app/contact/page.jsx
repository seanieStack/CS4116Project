...
export default function Contact() {
  return (
      <>
        <Navbar />
        <div className="mx-auto min-h-[calc(100vh-8em)] px-6 py-12 bg-gradient-to-b from-blue-200 dark:from-blue-950 text-white">
        ...
        <div className="w-full h-[26em] rounded-lg overflow-hidden mt-8">
        <iframe
