        ...
        <div className="bg-white dark:bg-[#0a0a0a] py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:text-center">
                    ...
                    <p className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 dark:text-white sm:text-5xl lg:text-balance">Everything
                        you need to deploy your app</p>
                    <p className="mt-6 text-lg/8 text-gray-600 dark:text-gray-200">Quis tellus eget adipiscing convallis sit sit eget
                ...
                <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
                    <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                        <div className="relative pl-16">
                            ...
                            <dd className="mt-2 text-base/7 text-gray-600 dark:text-gray-200">Morbi viverra dui mi arcu sed. Tellus semper
                        ...
                        <div className="relative pl-16">
                            ...
                            <dd className="mt-2 text-base/7 text-gray-600 dark:text-gray-200">Sit quis amet rutrum tellus ullamcorper
                        ...
                        <div className="relative pl-16">
                            ...
                            <dd className="mt-2 text-base/7 text-gray-600 dark:text-gray-200">Quisque est vel vulputate cursus. Risus proin
                        ...
                        <div className="relative pl-16">
                            ...
                            <dd className="mt-2 text-base/7 text-gray-600 dark:text-gray-200">Arcu egestas dolor vel iaculis in ipsum
